...
<main class="container">
    ...
    <article class="blog-content">
        <p class="intro">
            This SQL parser is implemented in <strong>four languages</strong> — TypeScript, Go, Rust, and Haskell — each 
            using the same algorithm to transform SQL queries into executable operations on JSON data. The TypeScript 
            version runs client-side in the browser, while Go, Rust, and Haskell each provide a server-side HTTP API. 
            Here's how they all work under the hood, using the Go implementation as the reference.
        </p>
        ...
        <section>
            ...
            <p>
                Every implementation follows the same three-stage pipeline: <strong>tokenization</strong>, <strong>parsing</strong>, 
            ...
            <p>
                Each language defines the same core structure — an <code>SQLParser</code> that holds data and exposes 
...
{'}'}</pre>
        ...
        <section>
            ...
            <div class="code-label">Go</div>
            <pre class="code-block">func (p *SQLParser) parseSelect(tokens []string) (*SelectQuery, error) {'{'}
...
└── where:
    ...
    A   AND
      ...
      B     C</pre>
            ...
            <p>
                In Go, each node is a <code>Condition</code> struct where <code>Left</code> and <code>Right</code> 
...
{'}'}</pre>
        ...
        <section>
            ...
            <div class="code-label">Go</div>
            <pre class="code-block">func (p *SQLParser) evaluateCondition(row Row, cond *Condition) bool {'{'}
